...
public class AddFees extends javax.swing.JFrame {
    ...
    public AddFees() {
        initComponents();
        getCoursesList();
        reciept_no.setText(getRecieptNumber()+"");
    ...
    private void initComponents() {
        ...
        jPanel3.add(courses, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 429, 210, 40));
        jPanel3.add(submition_date, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 40, 260, -1));

        jLabel18.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(102, 0, 0));
        jLabel18.setText("GSTIN :     77YKSJH55     ");
        jPanel3.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 100, 220, -1));

        jLabel19.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel19.setText("Mode Of Payment");
        jPanel3.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 180, -1));

        jLabel20.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel20.setText("TO");
        jPanel3.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 350, 50, -1));
        ...
        jPanel3.add(reciept_no, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 30, 210, 30));
        ...
        jPanel3.add(deposite_from, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 340, 140, 40));

        jLabel22.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel22.setText("THE FOLLOWING PAYMENT DEPOSITED FROM ");
        jPanel3.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 350, 380, -1));
        ...
        jPanel3.add(payment_option, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 79, 210, 40));
        ...
        jPanel3.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, 140, -1));
        ...
        recieved_from.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        recieved_from.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                recieved_fromActionPerformed(evt);
            }
        });
        jPanel3.add(recieved_from, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 240, 410, 40));
        ...
        jPanel3.add(deposite_to, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 340, 140, 40));

        payment1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        payment1.setText("Enter Bank Name:");
        jPanel3.add(payment1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, -1, -1));
        ...
        jPanel3.add(payment_id1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 140, 220, 30));
        ...
        jPanel3.add(payment_id2, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 140, 220, 40));
        ...
        jPanel3.add(cv_number, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 140, 260, 40));
...
// to check the payment method
    ...
    private void printMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_printMouseClicked
      if(getValidation())
      {
          ...
          int a = dboperation.DBOperation.insertStudentRecord(raw_ammount ,recieve_id, paid_ammount, cgst, sgst, datee,student_name,roll_number,
                  mode,upi_id,bank,cv,card,course_name,gst_num,amt_in_word,remark,year1,year2);
          if(a>0)
          {
    ...
    private void deposite_ammountKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_deposite_ammountKeyReleased
        ...
        if(deposite_ammount.getText().trim().matches("[1-9][0-9]*")&&!deposite_ammount.getText().trim().equals(""))
       {
           Float deposite = Float.parseFloat(deposite_ammount.getText().trim());
           Float gst = (deposite*9)/100;
       ...
       private boolean getValidation()
    {
         ...
         else if((payment_option.getSelectedIndex()==3)||(payment_option.getSelectedIndex()==4))
        {
         ...
         else if(!deposite_ammount.getText().trim().matches("[^0][0-9]*")||deposite_ammount.getText().trim().equals(""))
         {
   ...
   private int getRecieptNumber()
   {
       int reciept_no=0;
       try
       {
           Connection con = dbconnection.DBConnection.getConnection();
           PreparedStatement ps = con.prepareStatement("select max(reciept_no) from student_details");
           ResultSet rs = ps.executeQuery();
           if(rs.next())
           {
